      ...
      <div className="legal--container">
        ...
        <div className="info-container">
          <p>
            ...
            დაცვის შესახებ“ .კანონი „ოფიციალური სტატისტიკის შესახებ“
            განსაზღვრავს აღწერის თარიღის დადგენის, მისი მომზადების, ჩატარების,
            მოპოვებული მასალების დამუშავების, შედეგების გამოქვეყნებისა და
            გავრცელების წესს.
          </p>
          ...
          <img src={image1} alt="legal-image1" />
          ...
          <p style={{ marginTop: "-15px" }}>
            ...
            შევსებული აღწერის კითხვარის შინაარსი. მონაცემების გამოყენების წესის
            დარღვევისთვის აღმწერ პერსონალს დაეკისრება პასუხისმგებლობა
            საქართველოს მოქმედი კანონმდებლობით დადგენილი წესით.
          </p>
          <img src={image2} alt="legal-image2" />
          <p>
            აღწერის დროს შეგროვებული მონაცემების უსაფრთხოება უზრუნველყოფილია
            ასევე „პერსონალურ მონაცემთა დაცვის შესახებ“ საქართველოს კანონის 27-ე
            მუხლით.
          </p>
        </div>
      </div>
